...
export function KanbanColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      className={`bg-muted/30 rounded-xl p-3 flex flex-col min-w-[85vw] max-w-[85vw] sm:min-w-[320px] sm:max-w-[320px] md:min-w-[420px] md:max-w-[420px] h-full border-x border-b border-border/40 border-t-[4px] transition-all duration-300 backdrop-blur-sm ${
